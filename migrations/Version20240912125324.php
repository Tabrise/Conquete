 ...
 */
final class Version20240912125324 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contrat_articles (contrat_id INT NOT NULL, articles_id INT NOT NULL, INDEX IDX_6122B321823061F (contrat_id), INDEX IDX_6122B321EBAF6CC (articles_id), PRIMARY KEY(contrat_id, articles_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
